...
describe('Buttons TestCase', function () {
    ...
    describe('Button click', function () {
        it('should set active class on click', function () {
            ...
            button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="bold"]');
    ...
    describe('AppendEl', function () {
        it('should call the execFormatBlock method when button action is append', function () {
            ...
            selectElementContentsAndFire(editor.elements[0]);
            jasmine.clock().tick(1);
            button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-h3"]');
            fireEvent(button, 'click');
    ...
    describe('First and Last', function () {
        it('should add a special class to the first and last buttons', function () {
            var editor = new MediumEditor('.editor'),
                buttons = editor.toolbarObj.getToolbarElement().querySelectorAll('button');
    ...
    describe('Italics', function () {
        it('should call the execCommand for native actions', function () {
            ...
            var button,
                editor = new MediumEditor('.editor');
            selectElementContentsAndFire(editor.elements[0]);
            button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="italic"]');
            fireEvent(button, 'click');
    ...
    describe('Superscript', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="superscript"]');
    ...
    describe('Subscript', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="subscript"]');
    ...
    describe('Anchor', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="createLink"]');
    ...
    describe('Quote', function () {
        it('button should not be active if the selection is not inside a blockquote', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-blockquote"]');
    ...
    describe('OrderedList', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="insertorderedlist"]');
            ...
            expect(editor.toolbarObj.getToolbarElement().querySelector('[data-action="insertunorderedlist"]').classList.contains('medium-editor-button-active')).toBe(false);
    ...
    describe('UnorderedList', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="insertunorderedlist"]');

            this.el.innerHTML = '<ul><li id="li-lorem">lorem ipsum</li></ul>';
            selectElementContentsAndFire(document.getElementById('li-lorem'));
            expect(button.classList.contains('medium-editor-button-active')).toBe(true);
            // Ordered list button should not be active
            expect(editor.toolbarObj.getToolbarElement().querySelector('[data-action="insertorderedlist"]').classList.contains('medium-editor-button-active')).toBe(false);
    ...
    describe('Pre', function () {
        it('button should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                button = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-pre"]');
    ...
    describe('Justify', function () {
        it('buttons should deactivate other justify buttons', function () {
            ...
            var editor = new MediumEditor('.editor', {
                ...
                leftButton = editor.toolbarObj.getToolbarElement().querySelector('[data-action="justifyLeft"]'),
                rightButton = editor.toolbarObj.getToolbarElement().querySelector('[data-action="justifyRight"]'),
                centerButton = editor.toolbarObj.getToolbarElement().querySelector('[data-action="justifyCenter"]'),
                fullButton = editor.toolbarObj.getToolbarElement().querySelector('[data-action="justifyFull"]');
    ...
    describe('Header', function () {
        it('buttons should be active if the selection already has the element', function () {
            var editor = new MediumEditor('.editor', {
                ...
                buttonOne = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-h3"]'),
                buttonTwo = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-h4"]');
        ...
        it('buttons should be active if the selection already custom defined element types', function () {
            var editor = new MediumEditor('.editor', {
                ...
                buttonOne = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-h1"]'),
                buttonTwo = editor.toolbarObj.getToolbarElement().querySelector('[data-action="append-h5"]');
