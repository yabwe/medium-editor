...
describe('Buttons TestCase', function () {
    ...
    describe('Button Initial State', function () {
        ...
        it('should hide buttons if they are in the excludedActions option', function () {
            ...
            expect(editor.toolbar.querySelector('[data-element="ol"]').style.display).toBe('block');
            expect(editor.toolbar.querySelector('[data-element="ul"]').style.display).toBe('block');
        });
