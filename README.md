...
* __autoLink__: enables/disables the auto-linker feature, which automatically turns URLs entered into the text field into HTML anchor tags (similar to the functionality of Markdown). Default: false
